...
// 2) You are challenged to find the 4th element of the array,
...
// ANSWER: Both functions are doing the same things, without creating any new memory
...
class AddWithCache {
	...
	addThreeNums(num1, num2, num3) {
		...
		// this.cache, key: 123 if yes if no means cache hasnt hit this answer yet.
		if (this.cache.hasOwnProperty(propName)) {
			//then return '123': "answer"
...
// ANSWER: They're the exact same, because one is just a class and one is just a function pushing to an array.
...
console.log(addThreeNums(4, 5, 6));
console.log(addThreeNums(4, 5, 6));
console.log(addThreeNums(4, 5, 6));
console.log(addThreeNums(4, 5, 6));
...
console.log(add.addThreeNums(4, 5, 6));
console.log(add.addThreeNums(4, 5, 6));
console.log(add.addThreeNums(4, 5, 6));
console.log(add.addThreeNums(4, 5, 6));
